...
class IndexController extends Controller
{
  ...
  //     return view('index', ['scoreboards' => $scoreboards]);
  ...
  {
    $scoreboards = Scoreboard::with('user')->latest()->paginate(10);
  ...
  public function search(Request $request)
  {
    if ($request->ajax()) {
      ...
      $scoreboards = scoreboard::where('team1', 'like', '%' . $request->cari . '%')
        ->orwhere('team2', 'like', '%' . $request->cari . '%')->orwhere('created_at', 'like', '%' . $request->cari . '%')->latest()->get();
  ...
  public function search_tanggal(Request $request)
  {
    if ($request->ajax()) {
      ...
      $scoreboards = scoreboard::where('created_at', 'like', '%' . $request->cari . '%')->latest()->get();
